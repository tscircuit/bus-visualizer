...
const MeshGraph = () => {
  ...
  // Modified generateEdges function to include diagonal connections
  const generateEdges = (nodes) => {
    ...
    for (let i = 0; i < nodes.length; i++) {
      for (let j = i + 1; j < nodes.length; j++) {
        ...
        // Calculate the maximum allowed connection distance based on node sizes
